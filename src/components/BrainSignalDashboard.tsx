...
import {
    ...
    Signal, TrendingUp, Waves, Download, Share2, 
    RotateCcw, Monitor, MoreHorizontal
} from 'lucide-react';
...
export default function BrainSignalDashboard() {
            ...
            <div className="max-w-7xl mx-auto p-6">
                ...
                >
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <CustomButton onClick={toggleTheme} variant="ghost" size="md" className="h-10 w-10 p-0">
                ...
                <div className="grid grid-cols-12 gap-6 h-[calc(100vh-12rem)]">
                    ...
                    <div className="col-span-3 space-y-6">
                        {/* Connection Status */}
                        <motion.div 
                            className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm rounded-2xl p-6 border border-slate-200/60 dark:border-slate-800/60 hover:scale-[1.02] transition-transform duration-200"
                        ...
                        >
                            ...
                            <div className="space-y-3">
                                <CustomButton variant="outline" className="w-full gap-2 justify-start">
                    ...
                    <div className="col-span-6 space-y-6">
                        ...
                        <div className="grid grid-cols-3 gap-4">
                            {[
                                ...
                                <motion.div
                                    key={signal.title}
                                    className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm rounded-2xl p-4 border border-slate-200/60 dark:border-slate-800/60 hover:scale-[1.02] transition-transform duration-200"
                                    initial={{ opacity: 0, y: 20 }}
                                    animate={{ opacity: 1, y: 0 }}
